...
{
    public class CreateGameRequest(Guid id, string name, string genre, decimal price, DateOnly releaseDate, DateTime createdAt, string description, string publisher)
    {
        [Key]
